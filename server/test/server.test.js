...
describe('Test api/items/:id endpoint', function(){
  ...
  test('
  It should respond  with correct id'
  , async (done) => {
  ...
  test('
  It should  fail to respond  with correct main image'
  , async (done) => {
     const mainImage = '
  ...
  test('
  It should  respond  with correct main image'
  , async (done) => {
    const mainImage = '
    https://i.picsum.photos/id/99/200/200.jpg'
    ;
  ...
  test('
  It should  contain correct array items'
  , async (done) => {
    const mainImage = [
      '
